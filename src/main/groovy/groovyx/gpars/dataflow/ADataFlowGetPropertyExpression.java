 ...
 */
public class ADataFlowGetPropertyExpression<T> extends DataflowExpression<T> {
    private static final long serialVersionUID = 2984824057556784227L;
    private final DataflowExpression<T> receiver;
    private final String name;

    public ADataFlowGetPropertyExpression(final DataflowExpression<T> expression, final String name) {
