...
/**
 * ActorAction represents a chunk of work to perform on behalf of an associated PooledActor in one ego.
 ...
 * to avoid race conditions with te new ActorAction and should terminate quickly.
 *
 * @author Vaclav Pech
 * Date: Feb 7, 2009
 */
