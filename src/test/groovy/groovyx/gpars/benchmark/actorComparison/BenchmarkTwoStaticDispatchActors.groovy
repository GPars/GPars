...
private void performBenchmark(concurrencyLevel, numOfIterations) {
    4.times {
        ...
        final consumer = new BStaticDispatchConsumer(cdl)
...
final class BStaticDispatchConsumer extends StaticDispatchActor<Object> {

    private final def cdl

    def BStaticDispatchConsumer(final def cdl) {
        this.cdl = cdl
//        makeFair()
    }
