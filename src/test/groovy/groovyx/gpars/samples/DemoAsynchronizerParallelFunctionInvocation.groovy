 ...
 */
println groovyx.gpars.ThreadPool.executeAsyncAndWait({it * 2}.curry(10), {doubler(10)}, doubler.curry(10), {doubler.call(10)}, {{num -> num * 2}.call(10)})
...
ThreadPool.executeAsyncAndWait({storeName(names, 'Joe')}, {storeName(names, 'Dave')}, {storeName(names, 'Alice')}, {storeName(names, 'Jason')}, {storeName(names, 'George')}, {storeName(names, 'Susan')})
