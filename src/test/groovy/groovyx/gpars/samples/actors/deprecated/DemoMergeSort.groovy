...
package groovyx.gpars.samples.actors.deprecated
        ...
        receive {List<Integer> message ->
            ...
            switch (message.size()) {
                ...
                default:
                    ...
                    def child1 = GroupTestHelper.group.oldActor(createMessageHandler(delegate))
                    def child2 = GroupTestHelper.group.oldActor(createMessageHandler(delegate))
